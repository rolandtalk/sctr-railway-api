...
Same pattern as 60-symbol app; single /api/dashboard for one scrape + parallel yfinance.
"""
...
# Parallel workers for 300 symbols (slightly higher than 60-symbol app)
